...
void main() {
  ...
  var student3 = Student
      .myCustomConstructor(1,'ee' ); // One object, student3 is a reference variable
  student3.id = 54;
  student3.name = "Rahul";
  print("${student3.id} and ${student3.name}");

  var student4 = Student.myAnotherNamedConstructor(87, "mallu");
...
class Student {
  int id = -1;
  String name;
// in a class defual constructor and parameterised together not possible
